...
可参考 MCMOD 百科：[https://www.mcmod.cn/class/7803.html](https://www.mcmod.cn/class/7803.html)
...
| `swem:canter_ext`                                                                               | 跑步                                     |
| `swem:gallop`                                                                                   | 袭步                                     |
| `swem:jump_lv1`<br/>`swem:jump_lv2`<br/>`swem:jump_lv3`<br/>`swem:jump_lv4`<br/>`swem:jump_lv5` | 跳跃，共分五个等级                       |
