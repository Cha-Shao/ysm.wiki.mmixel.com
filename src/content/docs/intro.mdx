...
<Aside type="tip">目前最新版的 Yes Steve Model 版本号为 **2.4.1**</Aside>

<Aside type="tip">
  **2.4.1 版本**同时支持 1.16.5/1.18.2/1.19.2/1.20.1
  Forge，1.16.5/1.18.2/1.19.2/1.20.1/1.21/1.21.1 Fabric 和 1.21/1.21.1 NeoForge
  共计十二个版本。
</Aside>
...
<CardGrid>
  <ImageCard
    ...
    title="更真实的第一人称模型"
    desc="模组名 First-person Model，但是仍旧存在些许错误很难解决。"
    href="/"
  />
  <ImageCard
    src="/images/tacz.jpg"
    title="TAC/TACZ（永恒枪械工坊）"
    desc="可以完美的兼容该模组的持枪、换弹、瞄准、开火等诸多动作。"
    href="/"
  />
  <ImageCard
    src="/images/carry-on.jpg"
    title="Carry On"
    desc="能够在玩家抱起其他方块、实体时播放对应动画。1.19.2 和 1.20 版本的 Carry On 模组甚至可以抱起玩家，所以你可以在服务器与你的好友培养感情"
    href="/"
  />
  <ImageCard
    src="/images/slash-blade.jpg"
    title="Slash Blade（拔刀剑）"
    desc="可以渲染特定的主副手拔刀剑。2.3.0 版本添加了对拔刀剑动画的兼容，新增 33 个动画，可参考默认模型的 slashblade.animation.json 文件"
    href="/"
  />
  <ImageCard
    src="/images/swem.jpg"
