...
**Freesia 插件不是 YSM 官方作品**，它使用 [Mozilla Public License Version
...
Freesia 插件原作者为 [MrHua269](https://github.com/MrHua269)，现由
...
- 切勿将 Worker 服务器加入 Velocity 的子服列表，也不要将 `master_control_service` 和
  `msession` 端口暴露至公网，否则会带来安全隐患。
